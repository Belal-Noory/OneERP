...
async function seedModules() {
  ...
  await prisma.moduleCatalog.upsert({
    where: { id: "msp" },
    update: { ...base("msp"), isActive: true, nameKey: "module.msp.name", descriptionKey: "module.msp.description" },
    create: { ...base("msp"), isActive: true, nameKey: "module.msp.name", descriptionKey: "module.msp.description" }
  });
}
